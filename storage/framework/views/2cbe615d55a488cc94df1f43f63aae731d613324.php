...
<?php $__env->startSection('title', 'إدارة الإيرادات'); ?>
...
<div class="card p-4 shadow-sm">
  ...
  <form method="GET" action="<?php echo e(route('financial.revenues')); ?>" class="row g-3 mb-4 p-3 bg-light rounded">
    <div class="col-md-3">
      <label class="form-label">المصدر</label>
      <input type="text" name="source" value="<?php echo e(request('source')); ?>" class="form-control" placeholder="ابحث باسم المصدر">
    </div>

    <div class="col-md-3">
      <label class="form-label">النوع</label>
      
      <input type="text" name="type" value="<?php echo e(request('type')); ?>" class="form-control" list="revenueTypes" placeholder="اختر أو اكتب نوعًا">
    </div>
    ...
    <div class="col-12 text-center mt-3">
      ...
      <a href="<?php echo e(route('financial.revenues')); ?>" class="btn btn-secondary px-4 ms-2">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $revenues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td><?php echo e($rev->source); ?></td>
            <td><?php echo e($rev->type); ?></td>
            <td class="text-success fw-bold"><?php echo e(number_format($rev->amount, 3)); ?></td>
            <td><?php echo e($rev->date); ?></td>
            <td><?php echo e($rev->notes ?? '-'); ?></td>
            <td>
              <?php if($rev->attachment): ?>
                <a href="<?php echo e(asset('storage/'.$rev->attachment)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">عرض</a>
              <?php else: ?>
                <span class="text-muted">لا يوجد</span>
              <?php endif; ?>
            </td>
            <td>
              <button class="btn btn-sm btn-info text-white editBtn" data-rev='<?php echo json_encode($rev, 15, 512) ?>'>
                <i class="bi bi-pencil-square"></i>
              </button>
            </td>
            <td>
              <form method="POST" action="<?php echo e(route('financial.revenues.delete', $rev->id)); ?>" onsubmit="return confirm('هل أنت متأكد من الحذف؟');">
                <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(route('financial.revenues.store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="row g-3">
            <div class="col-md-6">
              <label class="form-label">المصدر</label>
...
<?php echo $__env->make('financial.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Alresalah-Managment\resources\views/financial/revenues.blade.php ENDPATH**/ ?>