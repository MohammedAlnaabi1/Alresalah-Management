...
<?php $__env->startSection('title', 'لوحة المعلومات المالية'); ?>
...
<form method="GET" class="d-flex justify-content-end align-items-center mb-4 bg-light p-3 rounded shadow-sm">
  ...
  <select name="month" class="form-select w-auto me-2">
    ...
    <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <option value="<?php echo e($m); ?>" <?php echo e(request('month') == $m ? 'selected' : ''); ?>>
        <?php echo e(\Carbon\Carbon::create()->month($m)->locale('ar')->translatedFormat('F')); ?>
  ...
  <select name="year" class="form-select w-auto me-2">
    <option value="">الكل</option>
    <?php $__currentLoopData = range(now()->year - 3, now()->year); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="row g-4 mb-4">
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0">
        ...
        <h4 class="fw-bold text-success"><?php echo e(number_format(($totalRevenues ?? 0), 2)); ?> ر.ع</h4>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0">
        ...
        <h4 class="fw-bold text-danger"><?php echo e(number_format(($totalExpenses ?? 0), 2)); ?> ر.ع</h4>
        <small class="text-muted">منذ بداية العام</small>
      </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0">
        ...
        <h4 class="fw-bold text-primary"><?php echo e(number_format($netBalance, 2)); ?> ر.ع</h4>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0">
        ...
        <h4 class="fw-bold text-warning"><?php echo e(number_format($busExpenses, 2)); ?> ر.ع</h4>
  ...
  <div class="row g-4 mb-4">
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-success-subtle">
        ...
        <h4 class="fw-bold text-success"><?php echo e(number_format($monthlyRevenue, 2)); ?> ر.ع</h4>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-danger-subtle">
        ...
        <h4 class="fw-bold text-danger"><?php echo e(number_format($monthlyExpense, 2)); ?> ر.ع</h4>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-primary-subtle">
        ...
        <h4 class="fw-bold text-primary"><?php echo e(number_format($monthlyRevenue - $monthlyExpense, 2)); ?> ر.ع</h4>
    ...
    <div class="col-md-6 col-xl-3">
      ...
      <div class="card p-4 text-center shadow-sm border-0 bg-light">
        ...
        <h4 class="fw-bold text-secondary"><?php echo e($topCategory ?? 'غير محدد'); ?></h4>
        <small class="text-muted"><?php echo e(number_format($topValue ?? 0, 2)); ?> ر.ع</small>
      </div>
    </div>
  </div>
  ...
  <div class="row g-4 mb-4">
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-light">
        ...
        <h4 class="fw-bold text-danger"><?php echo e(number_format($donationTotal, 2)); ?> ر.ع</h4>
      </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-light">
        ...
        <h4 class="fw-bold text-warning"><?php echo e(number_format($supportTotal, 2)); ?> ر.ع</h4>
      </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card p-4 text-center shadow-sm border-0 bg-light">
        ...
        <h4 class="fw-bold text-secondary"><?php echo e(number_format($transportTotal, 2)); ?> ر.ع</h4>
      </div>
    </div>
  </div>
      ...
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body p-0">
          <table class="table table-hover align-middle text-center m-0">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
...
<script>
  new Chart(document.getElementById('financeChart'), {
    ...
    data: {
      ...
      datasets: [
        { label: 'الإيرادات', data: <?php echo json_encode($monthlyRevenues, 15, 512) ?>, backgroundColor: 'rgba(0,107,143,0.8)' },
        { label: 'المصروفات', data: <?php echo json_encode($monthlyExpenses, 15, 512) ?>, backgroundColor: 'rgba(241,139,34,0.8)' }
      ]
    },
  ...
  new Chart(document.getElementById('expenseChart'), {
    type: 'doughnut',
    data: {
      labels: <?php echo json_encode($expenseCategories->keys(), 15, 512) ?>,
      datasets: [{ data: <?php echo json_encode($expenseCategories->values(), 15, 512) ?>, backgroundColor: ['#f18b22','#006b8f','#ffc107','#4bc0c0','#9c27b0'] }]
    },
    options: { responsive: true, plugins: { legend: { position: 'bottom' } } }
  });
  ...
  new Chart(document.getElementById('yearlyExpensesBar'), {
    type: 'bar',
    data: { labels: <?php echo json_encode($chartYears, 15, 512) ?>, datasets: [{ label: 'إجمالي المصروفات', data: <?php echo json_encode($chartTotals, 15, 512) ?>, backgroundColor: 'rgba(0,86,179,0.7)' }] },
    options: { responsive: true, scales: { y: { beginAtZero: true } } }
  });

  new Chart(document.getElementById('yearlyExpensesLine'), {
    type: 'line',
    data: { labels: <?php echo json_encode($chartYears, 15, 512) ?>, datasets: [{ label: 'إجمالي المصروفات', data: <?php echo json_encode($chartTotals, 15, 512) ?>, borderColor: '#00b35a', backgroundColor: 'rgba(0,179,90,0.2)', tension: 0.3, fill: true }] },
    options: { responsive: true, scales: { y: { beginAtZero: true } } }
  });
</script>
...
<?php echo $__env->make('financial.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Alresalah-Managment\resources\views/financial/index.blade.php ENDPATH**/ ?>