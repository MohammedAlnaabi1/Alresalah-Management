...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div>
      ...
      <a href="{{ route('student.honors') }}" class="{{ request()->routeIs('student.honors') ? 'active' : '' }}">
        <i class="bi bi-trophy me-2"></i> تكريم المتفوقين
      </a>
      <a href="{{ route('student.points') }}" class="{{ request()->routeIs('student.points') ? 'active' : '' }}">
  ...
  <div class="content">
    <div class="topbar">
      ...
      <div><i class="bi bi-person-circle me-1"></i> {{ session('username') ?? 'المستخدم' }}</div>
    </div>
